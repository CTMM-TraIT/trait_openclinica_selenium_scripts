...
java -jar selenium-server-standalone-2.47.1.jar -trustAllSSLCertificates -avoidProxy -userExtensions user-extensions.js -htmlSuite "*firefox  C:\\Documents and Settings\\j.rousseau\\Local Settings\\Application Data\\Mozilla Firefox\\firefox.exe" https://www.openclinica.nl/ test-performance-suite.html Results.html 
...
copy /Y results-runs.txt O:\Pub\dm-algemeen\CTMS\TraIT\WP1\performance-monitoring\VUmc-ONC-PC306
copy /Y results-runs-extended.txt O:\Pub\dm-algemeen\CTMS\TraIT\WP1\performance-monitoring\VUmc-ONC-PC306
ECHO Finished
@ECHO ON