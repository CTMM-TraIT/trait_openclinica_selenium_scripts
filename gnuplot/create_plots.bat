...
REM type ..\..\VUmc-ONC-PC306\results-runs-extended.txt | findstr "Extended_Edit_Existing_Subject_-_ClickSubjectMatrix" > Extended_Click_Through_Subject_Matrix-VUmc-ONC-PC306.dat
